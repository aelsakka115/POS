...
4. **Reporting يعمل بمبدأ Eventual Consistency دائمًا** — أي مؤشر يعكس آخر الأحداث المُعالَجة، بنفس ضمان Per-Tenant Ordered Delivery المُثبَّت في RFC-002 §16 Rule 8.
